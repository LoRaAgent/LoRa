...
void loop() {
  ...
  if(state == ONE){                   //อ่านค่าเซ็นเซอร์
    ...
    // Serial.print("state:");
    // Serial.println(state);
    Serial.print(distance);   Serial.print(temp);   Serial.print(hum);   Serial.print(busvoltage);   Serial.print(statusNode);   Serial.print(mode);   Serial.print(timeNormalMode);   Serial.println(timeDebugMode); 
    Mymessage = String(distance)+","+String(temp)+","+String(hum)+","+String(busvoltage)+","+String(statusNode)+","+String(mode)+","+String(timeNormalMode)+","+String(timeDebugMode);
